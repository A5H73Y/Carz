...
public class DefaultConfig extends VehiclezConfiguration {
	...
	protected void initializeConfig() {
		...
		this.addDefault("Version", Double.valueOf(Vehiclez.getInstance().getDescription().getVersion()));
	...
	public String getSignHeader() {
		return TranslationUtils.getTranslation("Vehiclez.SignHeader", false);
	}
